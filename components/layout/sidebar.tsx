...
const lecturerLinks = [
	...
	{ href: "/lecturer/grades", label: "Grades", icon: Settings },
];

const studentLinks = [
	{ href: "/student", label: "Dashboard", icon: LayoutDashboard },
	{ href: "/student/courses", label: "My Courses", icon: BookOpen },
	{ href: "/student/assignments", label: "Assignments", icon: Book },
	{ href: "/student/submissions", label: "Submissions", icon: FileText },
];
...
export function Sidebar() {
	...
	if (session.role === "admin") links = adminLinks;
	if (session.role === "lecturer") links = lecturerLinks;
	if (session.role === "student") links = studentLinks;
