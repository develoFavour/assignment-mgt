				...
				<div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
					<div className="space-y-1">
						...
						<p className="text-slate-500 font-medium">
							Configure university curriculum and lecturer assignments.
						</p>
					</div>
				...
				<div className="flex flex-wrap gap-4">
					{[
						...
						},
						{
							...
							value: courses.filter((c) => c.semester === "1").length,
							icon: Calendar,
							color: "text-indigo-600 bg-indigo-50",
						},
						{
							label: "Second Semester",
							value: courses.filter((c) => c.semester === "2").length,
							icon: Calendar,
						...
						<div
							key={i}
							className="flex items-center gap-3 px-6 py-3 bg-white rounded-2xl border border-slate-100 shadow-sm"
						>
							...
							<table className="w-full">
								<thead>
									<tr className="bg-slate-50/50">
										...
										<th className="text-right py-5 px-8 text-[10px] font-black text-slate-400 uppercase tracking-widest">
											Management
										</th>
									</tr>
								</thead>
												...
												<div className="flex items-center gap-3">
													<div className="h-8 w-8 rounded-lg bg-slate-100 flex items-center justify-center text-[10px] font-black text-slate-400 uppercase">
														{course.lecturer_name
															? (course.lecturer_name as string)
																.split(" ")
																.map((n) => n[0])
																.join("")
															: "NA"}
